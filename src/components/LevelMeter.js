...
export function LevelMeter({ level, state, height = 56, bars = 32 }) {
    const canvasRef = useRef(null);
    const historyRef = useRef(Array.from({ length: bars }, () => 0));
    ...
    return (_jsx("div", { style: { height, width: '100%' }, children: _jsx("canvas", { ref: canvasRef, style: { width: '100%', height: '100%', display: 'block' } }) }));
}
